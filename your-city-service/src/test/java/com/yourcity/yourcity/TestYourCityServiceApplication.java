...
public class TestYourCityServiceApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.from(YourCityServiceApplication::main).with(TestYourCityServiceApplication.class).run(args);
    }
